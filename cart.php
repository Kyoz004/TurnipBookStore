...
<section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="sub-total"> Thành tiền : <span><?php echo $sub_total = ($fetch_cart['quantity'] * $fetch_cart['price']); ?>vnđ</span> </div>
      </div>
      <?php
   ...
   <div class="cart-total">
      <p>Thành tiền : <span> <?php echo $grand_total; ?>vnđ</span></p>
      <div class="flex">
