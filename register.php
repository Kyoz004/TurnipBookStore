...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="password" placeholder="Nhập vào mật khẩu của bạn" required class="box">
      <input type="password" name="cpassword" placeholder="Xác nhận lại mật khẩu" required class="box">
      <select name="user_type" class="box">
         <option value="user">User</option>
         <!--<option value="admin">Admin</option> Mở khi mà bỏ uncomments--> 
      </select>
