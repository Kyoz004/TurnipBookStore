...
if(isset($_POST['order_btn'])){
   ...
   if($cart_total == 0){
      ...
      if(mysqli_num_rows($order_query) > 0){
         ...
         $message[] = 'Đặt hàng thành công! - Turnip chân thành cảm ơn bạn <3';
...
<section class="display-order">
   ...
   ?>
   <div class="grand-total"> Thành tiền tổng cộng : <span><?php echo number_format($grand_total, 0, ',', '.') . 'vnđ'; ?></span> </div>
...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Tên đường :</span>
            <input type="text" name="street" required placeholder="Tòa nhà A, Khu chung cư XYZ, Đường ABC,....">
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>Đất nước :</span>
            <input type="text" name="country" required placeholder="Vietnam">
         </div>
         <div class="inputBox">
            <span>Mã passcode :</span>
